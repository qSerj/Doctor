...
| И3 | Рецепт: паттерн найден → закреплён в коде или правилах → доставлен в App | инженер и агент | Core, App, установщик | не спроектирован |
...
- **Как Observer живёт на машине Оли** и что будет, если он зависнет: процесс в сеансе пользователя (как на стенде), служба для части с правами, часть App; сторож с перезапуском или короткоживущий процесс на каждый сеанс («зонд» из памяти 15.09.2026).
...
- **Пакет сеанса с машины Оли и срок хранения журналов** у Observer.
