...
public sealed class FormatDictionaryTests
{
    ...
    [
        // Слои внутри переходов в обоих боевых проектах — заливки и градиенты, файла не несёт ни один.
        // Читать эти ключи доктор всё равно обязан: сторожевое правило проверяет и слои переходов,
        // а слой перехода с подключённым файлом форматом не запрещён.
